...
<div class="login-box">
  <div class="login-logo">
    <img src="<?php echo base_url()?>uploads/tabungan.jpg" width="100px" height="100px">
    <br>
   
   <h3>APLIKASI TABUNGAN ONLINE</h3>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url();?>daftar/aksi_login" method="post" enctype="multipart/form-data">
